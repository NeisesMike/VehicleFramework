...
namespace AtramaVehicle
{
     ...
     */
    public class Atrama : MonoBehaviour, IProtoEventListener, IProtoTreeEventListener
    {
        ...
        // Set all of these in AtramaBuilder
        ...
        public void Awake()
        {
            ...
            AtramaManager.addAtrama(this);

            Logger.Log("Atrama finished awake");
        }
        ...
        public void Init()
        {
            ...
            //AtramaBuilder.buildAtrama(this);
            isInitialized = true;
        }
        ...
        {
            Logger.Log("Serialize Atrama");
        }

        public void OnProtoDeserialize(ProtobufSerializer serializer)
        {
            Logger.Log("Deserialize Atrama");
            vehicle.OnProtoDeserialize(serializer);
            this.Init();
        }
