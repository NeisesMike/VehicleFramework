...
namespace VehicleFramework.UpgradeModules
{
    ...
    {
        public static TechType AddToggleableModule(List<Tuple<TechType, int>> inputRecipe, string classId, string displayName, string description, Action<ModVehicle, int> OnToggle, float energyCostPerActivation = 1f, float timeToFirstActivation = 1f, float repeatRate = 1f, Atlas.Sprite icon=null, string tabName = "MVCM")
        {
