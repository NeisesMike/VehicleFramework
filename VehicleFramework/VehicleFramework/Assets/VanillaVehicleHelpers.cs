    ...
    public static class SeamothHelper
    {
        ...
        public static IEnumerator EnsureSeamoth()
        {
            while (Seamoth == null)
            {
                ...
                {
                    cor = Admin.SessionManager.StartCoroutine(CraftData.InstantiateFromPrefabAsync(TechType.Seamoth, request, false));
                    yield return cor;
                    cor = null;
                }
                else
    ...
    public static class PrawnHelper
    {
        ...
        public static IEnumerator EnsurePrawn()
        {
            while (Prawn == null)
            {
                ...
                {
                    cor = Admin.SessionManager.StartCoroutine(CraftData.InstantiateFromPrefabAsync(TechType.Exosuit, request, false));
                    yield return cor;
                    cor = null;
                }
                else
