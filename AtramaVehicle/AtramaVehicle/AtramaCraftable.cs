...
namespace AtramaVehicle
{
    public class AtramaCraftable : Craftable
    {
        ...
        {
            if (AtramaBuilder.atramaPrefab == null)
            {
                AtramaBuilder.Init();
            ...
            GameObject returnAtrama = GameObject.Instantiate(AtramaBuilder.atramaPrefab);
            returnAtrama.EnsureComponent<TechTag>().type = TechType;
            returnAtrama.EnsureComponent<PrefabIdentifier>().ClassId = ClassID;
            return returnAtrama;
        }
