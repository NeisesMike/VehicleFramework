...
namespace AtramaVehicle
{
    public class CoroutineHelper : MonoBehaviour
    {
        ...
        public void cobbleModule(Transform source, GameObject thisModule)
        {
            ...
            thisModule.GetComponent<uGUI_EquipmentSlot>().background = AtramaBuilder.CopyComponent(source.Find("Background").GetComponent<UnityEngine.UI.Image>(), background);
        ...
        public void cobbleArm(Transform source, GameObject thisModule)
        {
            ...
            AtramaBuilder.CopyComponent(source.Find("ArmBackground").GetComponent<RectTransform>(), armBackground);
            AtramaBuilder.CopyComponent(source.Find("ArmBackground").GetComponent<CanvasRenderer>(), armBackground);
            thisModule.GetComponent<uGUI_EquipmentSlot>().background = AtramaBuilder.CopyComponent(source.Find("ArmBackground").GetComponent<UnityEngine.UI.Image>(), armBackground);
        ...
        public void cobbleLeftArm(Transform source, GameObject thisModule)
        {
            ...
            AtramaBuilder.CopyComponent(source.Find("Hint").GetComponent<RectTransform>(), hint);
            AtramaBuilder.CopyComponent(source.Find("Hint").GetComponent<CanvasRenderer>(), hint);
            var hintImg = AtramaBuilder.CopyComponent(source.Find("Hint").GetComponent<UnityEngine.UI.Image>(), hint);
        ...
        {                        
            ...
            var exosuitRect = AtramaBuilder.CopyComponent(source.Find("Exosuit").GetComponent<RectTransform>(), atramaImage);
            ...
            AtramaBuilder.CopyComponent(source.Find("Exosuit").GetComponent<CanvasRenderer>(), atramaImage);

            var exosuitImage = AtramaBuilder.CopyComponent(source.Find("Exosuit").GetComponent<UnityEngine.UI.Image>(), atramaImage);
        ...
        public void cobbleNewModules(Transform slot1, Transform slot4, Transform leftArm)
        {
            ...
            AtramaBuilder.CopyComponent(slot1.Find("Background").GetComponent<RectTransform>(), backgroundBottom);
            AtramaBuilder.CopyComponent(slot1.Find("Background").GetComponent<CanvasRenderer>(), backgroundBottom);
            AtramaManager.atramaModule6.GetComponent<uGUI_EquipmentSlot>().background = AtramaBuilder.CopyComponent(slot1.Find("Background").GetComponent<UnityEngine.UI.Image>(), backgroundBottom);
            ...
            AtramaManager.atramaModule6.GetComponent<uGUI_EquipmentSlot>().iconRect = AtramaBuilder.CopyComponent(slot1.Find("IconRect").GetComponent<RectTransform>(), iconRectBottom);
