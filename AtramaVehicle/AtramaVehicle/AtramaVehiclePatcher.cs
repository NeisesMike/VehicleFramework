...
namespace AtramaVehicle
{
    ...
    public static class AtramaVehiclePatcher
    {
        ...
        private static AtramaCraftable atramaPrefab { get; set; }
        ...
        public static void Patch()
        {
            ...
            // TODO: edit the generic vehicle modules to include via text they may be used with the Atrama
